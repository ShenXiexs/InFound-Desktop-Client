export type AvgCommissionRateOption = 'All' | 'Less than 20%' | 'Less than 15%' | 'Less than 10%' | 'Less than 5%'
export type ContentTypeOption = 'All' | 'Video' | 'LIVE'
export type CreatorAgencyOption = 'All' | 'Managed by Agency' | 'Independent creators'
export type FollowerAgeOption = '18 - 24' | '25 - 34' | '35 - 44' | '45 - 54' | '55+'
export type FollowerGenderOption = 'All' | 'Female' | 'Male'
export type PerformanceGmvOption = 'MX$0-MX$100' | 'MX$100-MX$1K' | 'MX$1K-MX$10K' | 'MX$10K+'
...
export interface OutreachFilterConfigInput {
